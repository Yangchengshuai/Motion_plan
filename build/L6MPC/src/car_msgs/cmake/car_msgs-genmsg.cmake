...
set(MSG_I_FLAGS "-Icar_msgs:/home/lab/work/Motion_plan/src/L6MPC/src/car_msgs/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/lab/work/Motion_plan/src/L6MPC/src/car_msgs/msg/CarCmd.msg" NAME_WE)
add_custom_target(_car_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "car_msgs" "/home/lab/work/Motion_plan/src/L6MPC/src/car_msgs/msg/CarCmd.msg" "std_msgs/Header"
)
...
_generate_msg_cpp(car_msgs
  "/home/lab/work/Motion_plan/src/L6MPC/src/car_msgs/msg/CarCmd.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/car_msgs)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/car_msgs\")")
  # install generated code
  install(
